...
void HelpScene::performPrepare() {
    ...
    entity_components->push_back(factory.createText("Controllers get assigned to players in the", { 255, 255, 255, 255 }, 72, 1250, 500, 1250, 75, getRelativeModifier(), Layers::UI));
    entity_components->push_back(factory.createText("same order they are connected to the pc", { 255, 255, 255, 255 }, 72, 1250, 560, 1250, 75, getRelativeModifier(), Layers::UI));

    entity_components->push_back(factory.createText("How to play?", { 255, 255, 255, 255 }, 72, 200, 900, 300, 75, getRelativeModifier(), Layers::UI));
    entity_components->push_back(factory.createText("Try to be the last standing player by killing the other players", { 255, 255, 255, 255 }, 72, 850, 980, 1600, 75, getRelativeModifier(), Layers::UI));
}
